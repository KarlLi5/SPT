...
class VideoRecurrentTestDataset(data.Dataset):
    ...
    frames as input and output corresponding testH video frames. Modified from
...
class SingleVideoRecurrentTestDataset(data.Dataset):
    ...
    frames as input and output corresponding testH video frames (only input LQ path).

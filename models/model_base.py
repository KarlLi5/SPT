...
class ModelBase():
    ...
    # ----------------------------------------
    def save_network(self, save_dir, network, network_label, iter_label, epoch):
        # save_filename = '{}_{}_{}.pth'.format(iter_label, epoch, network_label)
        save_filename = 'model_{}_{}.pth'.format(iter_label, network_label)
        # save_filename = 'model_last.pth'
    ...
    def save_optimizer(self, save_dir, optimizer, optimizer_label, iter_label):
        save_filename = 'model_{}_{}.pth'.format(iter_label, optimizer_label)
        save_path = os.path.join(save_dir, save_filename)
